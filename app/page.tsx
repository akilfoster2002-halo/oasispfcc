    ...
    <div style={{
      ...
      <section style={{ position: 'relative', overflow: 'hidden', padding: '110px 24px 100px', display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center' }}>
        ...
        <div style={{ position: 'relative', zIndex: 1, ...fadeUp(heroIn, 0) }}>
          <div style={{ display: 'inline-flex', alignItems: 'center', gap: 8, padding: '6px 14px', borderRadius: 100, marginBottom: 36, background: 'rgba(248,113,113,0.10)', border: '1px solid rgba(248,113,113,0.22)', fontSize: 11, fontWeight: 600, letterSpacing: '0.06em', textTransform: 'uppercase', color: '#F87171' }}>
            <div style={{ width: 6, height: 6, borderRadius: '50%', background: '#F87171', boxShadow: '0 0 8px #F87171', animation: 'ping-dot 2s ease-in-out infinite' }} />
            Right now, someone is slipping away
          </div>
        </div>

        <h1 style={{ position: 'relative', zIndex: 1, fontFamily: 'var(--font-cormorant, "Cormorant Garamond"), Georgia, serif', fontSize: 'clamp(52px, 9vw, 108px)', fontWeight: 700, letterSpacing: '-0.02em', lineHeight: 1.0, margin: '0 0 12px', maxWidth: 860, color: 'rgba(255,255,255,0.97)', ...fadeUp(heroIn, 80) }}>
          You just don&apos;t
        </h1>
        <h1 style={{ position: 'relative', zIndex: 1, fontFamily: 'var(--font-cormorant, "Cormorant Garamond"), Georgia, serif', fontSize: 'clamp(52px, 9vw, 108px)', fontWeight: 700, letterSpacing: '-0.02em', lineHeight: 1.0, margin: '0 0 36px', maxWidth: 860, ...fadeUp(heroIn, 140) }}>
          <span style={{ background: 'linear-gradient(135deg,#EDD06A 0%,#C9A84C 40%,#A88A35 100%)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text', animation: 'shimmer-gold 4s ease-in-out infinite' }}>know who yet.</span>
        </h1>

        <p style={{ position: 'relative', zIndex: 1, fontFamily: 'var(--font-cormorant, "Cormorant Garamond"), Georgia, serif', fontSize: 'clamp(18px, 2.2vw, 24px)', lineHeight: 1.75, color: 'rgba(255,255,255,0.50)', maxWidth: 600, margin: '0 0 52px', ...fadeUp(heroIn, 220) }}>
          ...
          >
            ...
            <div style={{ padding: '24px', display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 14 }}>
              {[
                ...
                <div key={s.label} style={{ padding: '16px', borderRadius: 14, background: 'rgba(255,255,255,0.04)', border: `1px solid ${s.up ? 'rgba(255,255,255,0.07)' : 'rgba(248,113,113,0.12)'}`, opacity: heroIn ? 1 : 0, transform: heroIn ? 'translateY(0)' : 'translateY(12px)', transition: `opacity 0.5s ease ${600 + i * 80}ms, transform 0.5s ease ${600 + i * 80}ms` }}>
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: 4 }}>
                    {s.up ? <TrendingUp style={{ width: 10, height: 10, color: '#4ADE80' }} /> : <AlertCircle style={{ width: 10, height: 10, color: '#F87171' }} />}
                    <span style={{ fontSize: 10, color: s.up ? '#4ADE80' : '#F87171', fontWeight: 600 }}>{s.change}</span>
                  </div>
                </div>
              ))}
            </div>
            ...
            <div style={{ margin: '0 24px 24px', padding: '14px 18px', borderRadius: 14, background: 'rgba(201,168,76,0.07)', border: '1px solid rgba(201,168,76,0.16)', display: 'flex', alignItems: 'center', gap: 12, opacity: barsIn ? 1 : 0, transition: 'opacity 0.6s ease 1400ms' }}>
              ...
              <p style={{ fontSize: 12, color: 'rgba(255,248,220,0.62)', margin: 0, lineHeight: 1.5 }}>
                <span style={{ color: '#C9A84C', fontWeight: 600 }}>Aquila:</span>{' '}12 members haven&apos;t been seen in 3+ weeks. Cell 9D has dropped from 10 → 3 attendees in 6 weeks. Want me to draft follow-up messages?
              </p>
      ...
      ══════════════════════════════════════════════ */}
      <div ref={costSec.ref} style={{ borderTop: '1px solid rgba(255,255,255,0.05)', borderBottom: '1px solid rgba(255,255,255,0.05)', padding: '64px 24px', background: 'rgba(248,113,113,0.025)' }}>
        <div style={{ maxWidth: 1060, margin: '0 auto' }}>
          <p style={{ textAlign: 'center', fontSize: 11, fontWeight: 700, letterSpacing: '0.10em', textTransform: 'uppercase', color: 'rgba(248,113,113,0.60)', margin: '0 0 40px', ...fadeUp(costSec.visible, 0) }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: 20 }}>
            {[
              ...
              <div key={i} style={{ padding: '28px', borderRadius: 20, background: 'rgba(255,255,255,0.025)', border: '1px solid rgba(248,113,113,0.12)', ...fadeUp(costSec.visible, delay) }}>
                <p style={{ fontFamily: 'var(--font-cormorant, "Cormorant Garamond"), Georgia, serif', fontSize: 18, color: 'rgba(255,255,255,0.70)', margin: '0 0 16px', lineHeight: 1.55 }}>
                  &ldquo;{scenario}&rdquo;
                </p>
                <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                  <div style={{ width: 20, height: 20, borderRadius: '50%', background: 'rgba(248,113,113,0.12)', border: '1px solid rgba(248,113,113,0.24)', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
                    <AlertCircle style={{ width: 10, height: 10, color: '#F87171' }} />
                  </div>
                  <p style={{ fontSize: 13, color: '#F87171', margin: 0, fontWeight: 500 }}>{outcome}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      <section style={{ padding: '140px 24px 120px', position: 'relative', overflow: 'hidden', background: 'linear-gradient(180deg, #050810 0%, #06091A 50%, #050810 100%)' }}>
        ...
        <div ref={agentSec.ref} style={{ maxWidth: 1100, margin: '0 auto', position: 'relative', zIndex: 1 }}>
          ...
          <div style={{ textAlign: 'center', marginBottom: 72 }}>
            ...
            <h2 style={{ fontFamily: 'var(--font-cormorant, "Cormorant Garamond"), Georgia, serif', fontSize: 'clamp(40px, 6.5vw, 80px)', fontWeight: 700, letterSpacing: '-0.02em', lineHeight: 1.0, color: 'rgba(255,255,255,0.97)', margin: '0 0 24px', ...fadeUp(agentSec.visible, 80) }}>
            ...
            <p style={{ fontFamily: 'var(--font-cormorant, "Cormorant Garamond"), Georgia, serif', fontSize: 'clamp(17px, 1.8vw, 22px)', color: 'rgba(255,255,255,0.42)', lineHeight: 1.7, maxWidth: 620, margin: '0 auto', ...fadeUp(agentSec.visible, 160) }}>
            ...
            <div style={{ borderRadius: 28, overflow: 'hidden', background: 'linear-gradient(160deg, rgba(201,168,76,0.07) 0%, rgba(255,255,255,0.025) 40%, rgba(79,127,196,0.04) 100%)', border: '1px solid rgba(201,168,76,0.18)', boxShadow: '0 60px 140px rgba(0,0,0,0.60), 0 0 0 1px rgba(201,168,76,0.06) inset', backdropFilter: 'blur(40px)' }}>
              ...
              <div style={{ padding: '20px 28px', borderBottom: '1px solid rgba(255,255,255,0.07)', display: 'flex', alignItems: 'center', gap: 14, background: 'rgba(255,255,255,0.02)' }}>
                ...
                <div>
                  ...
                  <p style={{ fontSize: 12, color: 'rgba(255,255,255,0.30)', margin: '2px 0 0' }}>Connected to your live church data · Members · Cells · Services · Giving</p>
                </div>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 0 }}>
                <div style={{ padding: '28px', borderRight: '1px solid rgba(255,255,255,0.05)', display: 'flex', flexDirection: 'column', gap: 14 }}>
                  <p style={{ fontSize: 10, fontWeight: 700, letterSpacing: '0.07em', textTransform: 'uppercase', color: 'rgba(255,255,255,0.22)', margin: '0 0 4px' }}>Who is slipping away?</p>
                  {[
                ...
                <div style={{ padding: '28px', display: 'flex', flexDirection: 'column', gap: 14 }}>
                  <p style={{ fontSize: 10, fontWeight: 700, letterSpacing: '0.07em', textTransform: 'uppercase', color: 'rgba(255,255,255,0.22)', margin: '0 0 4px' }}>Who needs follow-up?</p>
                  {[
      ...
      <section style={{ padding: '120px 24px', position: 'relative', background: 'linear-gradient(180deg, #050810 0%, #070A16 100%)' }}>
        ...
        <div ref={cellSec.ref} style={{ maxWidth: 1120, margin: '0 auto', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(340px, 1fr))', gap: 72, alignItems: 'center' }}>
          ...
          <div style={fadeUp(cellSec.visible, 0)}>
            ...
            <h2 style={{ fontFamily: 'var(--font-cormorant, "Cormorant Garamond"), Georgia, serif', fontSize: 'clamp(30px, 4vw, 50px)', fontWeight: 700, letterSpacing: '-0.02em', color: 'rgba(255,255,255,0.95)', margin: '0 0 20px', lineHeight: 1.1 }}>
              See who&apos;s drifting before they&apos;re gone.
            </h2>
            <p style={{ fontFamily: 'var(--font-cormorant, "Cormorant Garamond"), Georgia, serif', fontSize: 17, color: 'rgba(255,255,255,0.42)', lineHeight: 1.8, margin: '0 0 36px' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 16, ...fadeUp(cellSec.visible, 160) }}>
            ...
            >
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 16 }}>
                ...
                <span style={{ fontSize: 12, fontWeight: 700, padding: '4px 10px', borderRadius: 99, background: 'rgba(248,113,113,0.12)', border: '1px solid rgba(248,113,113,0.28)', color: '#F87171' }}>Declining</span>
              </div>
              <div style={{ display: 'flex', gap: 6, marginBottom: 16 }}>
              ...
              <div style={{ padding: '10px 14px', borderRadius: 12, background: 'rgba(248,113,113,0.07)', border: '1px solid rgba(248,113,113,0.14)', display: 'flex', alignItems: 'center', gap: 10 }}>
                ...
                <p style={{ fontSize: 12, color: 'rgba(248,200,200,0.70)', margin: 0, lineHeight: 1.5 }}>10 → 3 attendees in 6 weeks. Aquila flagged this 3 weeks ago.</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 16, ...fadeUp(msgSec.visible, 0) }}>
            <div style={{ padding: '22px', borderRadius: 22, background: 'linear-gradient(145deg, rgba(201,168,76,0.07), rgba(255,255,255,0.015))', border: '1px solid rgba(201,168,76,0.16)' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 18 }}>
                ...
                <p style={{ fontSize: 13, fontWeight: 600, color: '#C9A84C', margin: 0 }}>Aquila drafted 3 follow-ups — ready to review</p>
              </div>
              {[
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 22 }}>
              {[
                ...
                <div key={title} style={{ display: 'flex', gap: 14, opacity: msgSec.visible ? 1 : 0, transform: msgSec.visible ? 'translateY(0)' : 'translateY(16px)', transition: `opacity 0.6s ease ${280 + i * 80}ms, transform 0.6s ease ${280 + i * 80}ms` }}>
                  ...
                  <div>
                    <p style={{ fontSize: 14, fontWeight: 600, color: 'rgba(255,255,255,0.85)', margin: '0 0 4px' }}>{title}</p>
                    <p style={{ fontSize: 13, color: 'rgba(255,255,255,0.36)', lineHeight: 1.65, margin: 0 }} dangerouslySetInnerHTML={{ __html: desc }} />
                  </div>
                </div>
              ))}
            </div>
      ...
      <section style={{ padding: '80px 24px 100px' }}>
        <div ref={tileSec.ref} style={{ maxWidth: 1120, margin: '0 auto' }}>
          <div style={{ textAlign: 'center', marginBottom: 56, ...fadeUp(tileSec.visible, 0) }}>
            <h2 style={{ fontFamily: 'var(--font-cormorant, "Cormorant Garamond"), Georgia, serif', fontSize: 'clamp(26px, 3.5vw, 42px)', fontWeight: 700, letterSpacing: '-0.02em', color: 'rgba(255,255,255,0.94)', margin: '0 0 14px' }}>Everything your pastoral team needs, built in.</h2>
            <p style={{ fontFamily: 'var(--font-cormorant, "Cormorant Garamond"), Georgia, serif', fontSize: 18, color: 'rgba(255,255,255,0.32)', margin: 0, maxWidth: 440, marginLeft: 'auto', marginRight: 'auto', lineHeight: 1.6 }}>One platform. No switching between tools, spreadsheets, and group chats.</p>
          </div>
      ...
      <section style={{ padding: '0 24px 100px' }}>
        <div ref={ctaSec.ref} style={{ maxWidth: 880, margin: '0 auto', borderRadius: 32, padding: '90px 48px', textAlign: 'center', position: 'relative', overflow: 'hidden', background: 'linear-gradient(145deg, rgba(201,168,76,0.11) 0%, rgba(55,48,163,0.07) 50%, rgba(5,8,16,0.96) 100%)', border: '1px solid rgba(201,168,76,0.18)', ...fadeUp(ctaSec.visible, 0) }}>
          ...
          <div style={{ position: 'relative' }}>
            ...
            <h2 style={{ fontFamily: 'var(--font-cormorant, "Cormorant Garamond"), Georgia, serif', fontSize: 'clamp(32px, 5vw, 60px)', fontWeight: 700, letterSpacing: '-0.02em', color: 'rgba(255,255,255,0.96)', margin: '0 0 20px', lineHeight: 1.06 }}>
              Stop losing people to the gap between intention and information.
            </h2>
            <p style={{ fontFamily: 'var(--font-cormorant, "Cormorant Garamond"), Georgia, serif', fontSize: 19, color: 'rgba(255,255,255,0.38)', maxWidth: 500, margin: '0 auto 48px', lineHeight: 1.7 }}>
